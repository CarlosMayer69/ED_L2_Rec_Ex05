 ...
 * devemos realizar a fatoração por meio da decomposição 
 ...
 * ver quais números dividiram, simultaneamente, nas duas colunas e multiplicá-los.
 * 
...
public class MDCRecursivoController {
	
	public MDCRecursivoController() {
		super();
	}
